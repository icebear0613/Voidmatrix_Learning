...
public:
    ...
    void on_attack()
    {
        ...
        switch (rand() % 2) {
            case 0:
                mciSendString(_T("play pea_shot_1 from 0"), NULL, 0, NULL);
                break;
            case 1:
                mciSendString(_T("play pea_shot_2 from 0"), NULL, 0, NULL);
                break;
        }
    }
    ...
    void on_attack_ex()
    {
        ...
        mciSendString(_T("play pea_shot_ex from 0"), NULL, 0, NULL);
    }
