...
public:
    ...
    void on_entry()
    {
        ...
        pos_1P_selector_btn_left.y = pos_img_1P_gravestone.y + (img_gravestone_right.getheight() - img_1P_selector_btn_idle_left.getheight());
...
private:
    ...
    LPCSTR str_peashooter_name = _T("PeaShooter");
    LPCSTR str_sunflower_name = _T("Sunflower");
...
private:
    void outtextxy_shaded(int x, int y, LPCSTR str)
    {
