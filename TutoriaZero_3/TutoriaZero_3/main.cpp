...
void load_game_resources()
{
	...
	loadimage(&img_peashooter_selector_background_right, _T("img_peashooter_selector_background_right"));
	flip_image(&img_peashooter_selector_background_right, &img_peashooter_selector_background_left);
	loadimage(&img_sunflower_selector_background_right, _T("img_sunflower_selector_background_right"));
	...
	loadimage(&img_1P_cursor, _T("resources/1P_cursor"));
	loadimage(&img_2P_cursor, _T("resources/2P_cursor"));
	...
	loadimage(&img_1P_winner, _T("resources/img_1P_winner_%d.png"));
	loadimage(&img_2P_winner, _T("resources/img_2P_winner_%d.png"));
	loadimage(&img_winner_bar, _T("resources/img_winner_bar_%d.png"));

	loadimage(&img_avatar_peashooter, _T("sources/img_avatar_peashooter"));
	loadimage(&img_avatar_sunflower, _T("sources/img_avatar_sunflower"));
	...
	mciSendString(_T("open resources/pea_break_1.mp3 alias pea_break_1"), NULL, 0, NULL);
	mciSendString(_T("open resources/pea_break_2.mp3 alias pea_break_2"), NULL, 0, NULL);
	mciSendString(_T("open resources/pea_break_ex.mp3 alias pea_break_ex"), NULL, 0, NULL);
